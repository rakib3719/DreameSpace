...
const Cards = () => {
    ...
    return (
        <div  className="mt-16" >
          ...
          <p   className="text-orange-500 font-workSense" >Our Featured Properties For Sale and Rent</p>
            <h1  className=" text-2xl lg:text-3xl font-playFair font-bold" >Properties For Sale & Rent</h1>
